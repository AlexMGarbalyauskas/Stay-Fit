  ...
  if (!isAuthenticated) {
    return (
      <>
        ...
        <div className={`min-h-screen pb-24 pt-20 ${isDark ? 'bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800' : 'bg-gradient-to-br from-blue-50 to-green-100'}`}>
          <div className="px-4 max-w-md mx-auto text-center mt-20">
            <div className="mb-8">
              ...
              <h1 className={`text-4xl font-bold mb-4 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>{t('welcomeToStayFit')}</h1>
              <p className={`text-lg px-4 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>{t('joinFitnessCommumity')}</p>
            </div>
